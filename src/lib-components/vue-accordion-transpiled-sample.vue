<script>
export default {
    name: 'VueAccordionTranspiledSample', // vue component name
    data() {
        return {
            counter: 5,
            initCounter: 5,
...
<template>
    <div class="vue-accordion-transpiled-sample">
...
<style scoped>
    .vue-accordion-transpiled-sample {
        display: block;
        width: 400px;
        margin: 25px auto;
    ...
    .vue-accordion-transpiled-sample p {
        margin: 0 0 1em;
    }
</style>
